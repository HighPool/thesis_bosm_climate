...
def main():
    ...
    base_out_dir = Path("results/wind/final") / experiment_tag / algo_tag
    ...
    summary_path = (
        base_out_dir
        / f"{algo_tag}_summary_wind_n{n_turbines}_budget{budget}_runs{n_runs}.json"
    )
    csv_path = (
        base_out_dir
        / f"{algo_tag}_ioh_wind_n{n_turbines}_budget{budget}_runs{n_runs}.csv"
    )
